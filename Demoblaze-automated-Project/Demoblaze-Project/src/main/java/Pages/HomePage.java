...
public class HomePage {
   ...
   public HomePage(WebDriver driver) {
    ...
    public void clickNexus6() {
       // wait.until(ExpectedConditions.visibilityOfElementLocated(nexus6));
       // driver.findElement(nexus6).click();
        BrowserActions.clickWithRetry(driver,nexus6);
    }
    ...
    public void goToCart() {
        ...
        BrowserActions.clickWithRetry(driver,cartLink);
    }
